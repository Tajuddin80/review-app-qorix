...
(function () {
  ...
  function initReviewReel() {
    document
      .querySelectorAll('[data-section="qorix-review-reel-widget"]')
      .forEach(function (section) {
        if (section.dataset.qorixReviewReelInitialized === "true") return;

        const container = section.querySelector(".mySwiper");
        ...
        section.dataset.qorixReviewReelInitialized = "true";
        ...
        const gapBetweenCards =
          parseInt(
            computedStyle.getPropertyValue("--gap-between-cards").trim(),
            10,
          ) || 8;
        const autoplayEnabled =
          computedStyle.getPropertyValue("--autoplay-enabled").trim() ===
          "true";
        const autoplaySpeed =
          parseInt(
            computedStyle.getPropertyValue("--autoplay-speed").trim(),
            10,
          ) || 4000;
        ...
        const swiperOptions = {
          ...
          navigation: {
            nextEl: section.querySelector(
              ".qorix-review-reel-swiper-button-next",
            ),
            prevEl: section.querySelector(
              ".qorix-review-reel-swiper-button-prev",
            ),
          },
          breakpoints: {
            768: { slidesPerView: 2, spaceBetween: gapBetweenCards },
        ...
        const swiper = new window.Swiper(container, swiperOptions);
        let currentVideo = null;
        let activePaginationIndex = swiper.realIndex || 0;
        let pendingPaginationIndex = null;
        ...
        function realSlideCount() {
          ...
          return indexes.size || container.querySelectorAll(".swiper-slide").length;
        }
        ...
        function updatePagination(activeIndex) {
          ...
          paginationContainer
            .querySelectorAll(".qorix-review-reel-custom-pagination-btn")
            .forEach(function (button) {
              const index = parseInt(button.dataset.index, 10);
              const isActive = index === activePaginationIndex;
        ...
        function buildPagination() {
          ...
          for (let i = 0; i < realSlideCount(); i += 1) {
            ...
            button.type = "button";
            button.className = "qorix-review-reel-custom-pagination-btn";
        ...
        section
          ...
          .forEach(function (wrapper) {
            const video = wrapper.querySelector("video");
            const button = wrapper.querySelector(".qorix-review-reel-play-btn");
        ...
        swiper.on("slideChange", function () {
          pauseAllVideos();
          updatePagination(
            pendingPaginationIndex !== null
              ? pendingPaginationIndex
              : swiper.realIndex || 0,
          );
        });
        ...
        swiper.on("transitionEnd", function () {
          if (
            pendingPaginationIndex !== null &&
            swiper.realIndex === pendingPaginationIndex
          ) {
            pendingPaginationIndex = null;
          }
        ...
        swiper.on("loopFix resize observerUpdate", function () {
          updatePagination();
        });
      });
  }
  ...
  document.addEventListener("shopify:section:load", initReviewReel);
})();